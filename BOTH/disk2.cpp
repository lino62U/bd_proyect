...
class Disco
{
    ...
    public:
        ...
        void loadDataScheme(string nameScheme, string nameTable)
        {
            ...
            assignData_Disco(nameTable, register_size, file_register_size);
        }
        ...
        void assignData_Disco(string nameArchivo, int register_size, int file_register_size)
        {
            ...
            archivo.close();
            number_lines = size/(register_size +1);
...
class Directorio
{
    ...
    void makeDirectory(Bloque *block)
    {
...
int main()
{
    Disco disco(2, 30, 10, 36);
    disco.loadDataScheme("scheme","students");
    
    disco.getSector(0,0, 0,5);

    //disco.giro();
    // vector <Sector *> b = disco.cabezal_lectura(0,0, 0,0,5);
    // cout<<"HOLA "<<endl;
    ...
    // string file1 = "files/titanic.txt";
	// string file2 = "files/titanic2.txt";

    // generate_txt(pesos,file1,file2);
    // disco.importarData_Disco("students");
    // //disco.giro();
    // vector <Sector *> b = disco.cabezal_lectura(0,0, 0,1,3);
    // cout<<"HOLA "<<endl;
    // for(auto i:b){
    //     cout<<i->getData()<<endl;
    // }
