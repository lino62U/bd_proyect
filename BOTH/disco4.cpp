...
class Directorio
{
    ...
    public:
        Directorio(int num_block, int num_sec_block)
        {
            cantidad_bloques = num_block;
            sectores_por_bloques = num_sec_block;
        }
        void makeDirectory(int cantidad_bloques, int cantidad_sector_por_bloque, Disco *ptrDisco)
        {
            cantidad_bloques = cantidad_bloques;
            sectores_por_bloques = cantidad_sector_por_bloque;
            // int auxPl=pPlato;
            // int auxSpr=pSuperficie;
            // int auxPst=pPista;
            // int pSector=gap_Sector;
            ...
            {
                directorio.push_back(new Bloque(ptrDisco));
                directorio[i]->making_Block(0,0,0,0,sectores_por_bloques);
            }
...
{
    int n;
    cout<<"\tNumero de sectores: ";cin>>n;
    cout<<"Making block"<<endl;

}
void opcion_5(Disco *ptrDisk)
{
...
void menu_opciones(Disco *ptrDisco)
{
    ...
    while (true)
    {
        ...
        cout<<"\t4. Imprimir datos de un BLOQUE"<<endl;
        cout<<"\t5. Imprimir datos de un DIRECTORIO"<<endl;
        cout<<"\t6. Salir"<<endl;
        ...
        else if(opc==5) opcion_5(ptrDisco);
        else return;
        menu();
    }
...
int main()
{
    ...
    // Disco disco(3, 10, 200, 692);
    // disco.loadDataScheme("scheme",nameTable.c_str());
    // disco.getDisk_info();
    // disco.getSector(2,8,0,5);
